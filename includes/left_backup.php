        ...
        <br />
        <a href="<?=$PHP_SELF?>?status=sign_out">log out</a>
        <? }?>
	</div>
<!-- end login box -->
                <!--Menu-->
...
<h3 class="menuheader expandable">image library</h3>
...
<li><a href="image_library.php?category_id=<?=$category_row['image_category_id']?>&parent_id=<?=$category_row['parent_id']?>&category_name=<?=Encrypt($category_row['image_category_name'])?>"><?=$category_row['image_category_name']?></a></li>
<? }?>

</ul>
<h3 class="menuheader expandable">video library</h3>
<ul class="categoryitems">
...
<li><a href="video_library.php?category_id=<?=$category_row['category_id']?>&category_name=<?=Encrypt($category_row['category_name'])?>"><?=$category_row['category_name']?></a></li>
<? }?>
