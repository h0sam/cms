                	...
                	<ul>
                    	   ...
                    	   <? 
                            ...
                            <div id="Menulevel2">
                                <ul>
                                    ...
                                    <li><a href="content_details.php?content_category_id=<?=$select_content_row['category_id']?>&content_id=<?=$select_content_row['content_id']?>" title="<?=$select_content_row['content_title']?>"><?=$select_content_row['content_title']?></a></li>
                                    <? }?>
                                </ul>
                            </div>
                            <? }?>
                        ...
                        <? }?>
                    	   <? 
							...
							?>
                                    <li><a href="content_list.php?content_category_id=<?=$site_category_row['category_id']?>" title="<?=$site_category_row['category_name']?>"><?=$site_category_row['category_name']?></a></li>
                    		<? }?>
