...
<body>
		...
		<section id="content">
			...
			Looks good with tableless, schematic markup.</p>
				...
				<form id="class_add" action="submit.php?page=classes&action=new" method="post" >
                ...
                <fieldset>
						...
						<section><label for="class_name">Class Name</label>
							<div><input type="text" id="class_name" name="class_name" required data-errortext="Class Name is mandatory!">
                        ...
                        <section><label for="days_num">Days</label>
							<div><input id="days_num" name="days_num" type="number" class="integer" required="required">
